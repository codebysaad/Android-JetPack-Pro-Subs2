...
public class ActivityTest {
    ...
    public void toDetailActivityTest() {
        ...
        onView(withId(R.id.rv_movie)).perform(RecyclerViewActions.actionOnItemAtPosition(2, click()));
        try {
            Thread.sleep(3000);
        }catch (InterruptedException e){
            e.printStackTrace();
        ...
        onView(withId(R.id.title_movie_detail)).check(matches(withText("The Lion King")));
    }
}
