...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    private List<MovieModels> mModels = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull MovieAdapter.MovieViewHolder holder, final int position) {
        ...
        holder.overview.setText(getListMovies().get(position).getOverview());
        ...
        Glide.with(holder.itemView.getContext())
                .load(DummyData.baseImageUrl + getListMovies().get(position).getPoster_path())
